...
* ➖ Heavy-tailed noise / outliers: consider robust filters or adaptive (Q/R).

**Ideas for extensions**

* Velocity & innovation plots; covariance bands ((\pm2\sigma)).
...
* **License:** *Add one (e.g., MIT) or link to `LICENSE`.*
